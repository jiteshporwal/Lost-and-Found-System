      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="membercredential.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Member Credential</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Member Credential</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Member Credential Data table</h3> 
                        ...
                        <div class="modal-dialog modal-sm">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="card card-primary">
                              ...
                              <div class="col-12">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Credential</label>
                                  <input type="text" class="form-control" id="" placeholder="Enter Credential Name ..">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">
